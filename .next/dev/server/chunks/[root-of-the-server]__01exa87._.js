...
"[project]/src/app/api/humanize/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const modelName = allowedModels.includes(selectedModel) ? selectedModel : "gemini-3.1-pro-preview";
        ...
        if (tone === "Professional") {
            toneInstruction = "Rewrite for a professional context — think polished business email or a well-edited report. Keep it human and direct, but avoid slang. Cut fluff ruthlessly.";
        } else if (tone === "Casual") {
            toneInstruction = "Rewrite this like someone explaining it to a friend over coffee. Use contractions, maybe a dash of humor, and don't overthink the structure. It's fine to be a little rough around the edges.";
        } else if (tone === "Creative") {
            toneInstruction = "Rewrite this with personality and flair. Use vivid language, unexpected word choices, and let the writing breathe. Think editorial essay, not textbook.";
        } else {
            toneInstruction = "Rewrite this to sound like a normal person wrote it. Not too formal, not too casual. Just natural, clear, human writing.";
        }
...
"""`;
        ...
        humanizedText = humanizedText.replace(/^#+\s+/gm, "") // Remove markdown headers
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01exa87._.js.map